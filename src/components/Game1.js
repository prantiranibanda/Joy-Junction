		...
		<div>
			<div className="flex h-[58vh] items-center justify-center">
				<div className="border-8 border-[#fa02e1]">
					<div className="relative flex items-center justify-center border-4 border-red-600">
						{winner ? (
							<div
								className={`absolute h-1 rounded-md bg-red-700 ${strikethrough}`}
							></div>
						) : (
							<div
								className={`absolute hidden h-1 bg-red-500 ${strikethrough}`}
							></div>
						)}
						<div className="grid h-64 w-64 grid-cols-3 gap-2 border-8 border-yellow-300 bg-orange-400">
